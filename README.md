...
**Bioinformatician · Computational Genomics · Microbiome Analysis · 3D Genome Architecture**

MSc Bioinformatics, University of Melbourne (2026) · Research Assistant, Hoffmann Lab, Bio21 Institute
...
![HPC](https://img.shields.io/badge/HPC-Spartan%20%7C%20GADI-orange?style=flat-square)
![QIIME2](https://img.shields.io/badge/QIIME2-microbiome-lightgrey?style=flat-square)
![HiCExplorer](https://img.shields.io/badge/HiCExplorer-3D%20genomics-lightgrey?style=flat-square)

> 🟢 Open to bioinformatics and research roles from mid-2026 · Part-time available now

---

## About

I work at the intersection of computational and molecular genomics. My research spans two main areas:
...
### 🦠 [16S-microbiome-pipeline](https://github.com/<jasmeenkaur>/16S-microbiome-pipeline)

End-to-end 16S rRNA amplicon pipeline for profiling microbial communities in field-collected insects and mosquito populations. Full pipeline from raw reads through to taxonomy barplots and beta-diversity analysis.

`QIIME2` `cutadapt` `DADA2` `SILVA 138` `biom-format` `Python` `R` `Spartan HPC`
...
📧 kaur.jasmeen1106@gmail.com · [LinkedIn](https://linkedin.com/in/jasmeen-kaur-972487129)
